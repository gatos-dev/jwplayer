...
exports["default"] = (function (id, ariaLabel) {
    return ("<div id=\"".concat(id, "\" class=\"jwplayer jw-reset jw-state-setup\" tabindex=\"0\" aria-label=\"").concat((ariaLabel || ''), "\" role=\"application\">") +
